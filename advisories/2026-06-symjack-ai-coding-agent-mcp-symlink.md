...
- [Adversa AI — SymJack: How Symlinks Let Attackers Hijack AI Coding Agents via MCP Server Registration](https://adversa.ai/blog/symjack-symlink-mcp-hijack) — primary disclosure
- [SecurityWeek — SymJack Attack Tricks AI Coding Agents Into Installing Malicious MCP Servers](https://securityweek.com/symjack-attack-tricks-ai-coding-agents-into-installing-malicious-mcp-servers/) — incident coverage and vendor response summary
- [The Hacker News — New SymJack Attack Lets Threat Actors Hijack AI Coding Agents via Symlinks](https://thehackernews.com/2026/06/new-symjack-attack-lets-attackers.html) — broader coverage
